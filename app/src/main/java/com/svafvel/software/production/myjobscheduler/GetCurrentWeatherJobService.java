...
public class GetCurrentWeatherJobService extends JobService {
    ...
    final String APP_ID = "a1a2061e19ace88fc9903d09c9d77ebf";
        ...
        client.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    double tempInKetlvin = responseObject.getJSONObject("main").getDouble("temp");
                    double tempInCelcius = tempInKetlvin - 273;
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                ...
                // Ketika proses gagal, maka jobFinished diset dengan parameter true, Yang artinya
                // job perlu di reschedule
